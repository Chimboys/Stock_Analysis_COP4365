using Project3Stock_Akmal.Code;
using Project3Stock_Akmal.Code.Patterns;
using System;
...
namespace Project3Stock_Akmal
{
    ...
    {
        //Created list to contain data for smartcandlesticks that come from csv file
        ...
        private void ShowTickerAndTimeframe(string pathToFile)
        {
            ...
            // Assigning labels text values to show title of ticker and timeframe
            Label_Ticker.Text = ticker;
            Label_Timeframe.Text = timeframe;
        }
